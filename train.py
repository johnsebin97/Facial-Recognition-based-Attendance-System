...
message = tk.Label(window, text="Facial_Recognition_Based_Attendance_System" ,bg="Green"  ,fg="white"  ,width=50  ,height=3,font=('times', 30, 'bold underline')) 
...
def TrainImages():
    ...
    harcascadePath = r"C:\Users\Grace\Downloads\SJgithub\Face-Recognition-Based-Attendance-System\haarcascade_frontalface_default.xml"
    detector =cv2.CascadeClassifier(harcascadePath)
    faces,Id = getImagesAndLabels("TrainingImage")
    recognizer.train(faces, np.array(Id))
    recognizer.save(r"C:\Users\Grace\Downloads\SJgithub\Face-Recognition-Based-Attendance-System\TrainingImageLabel\Trainner.yml")
...
quitWindow.place(x=975, y=500)
copyWrite = tk.Text(window, background=window.cget("background"), borderwidth=0,font=('times', 30, 'italic bold underline'))
copyWrite.tag_configure("superscript", offset=10)
copyWrite.insert("insert", "Developed by John","", "TEAM", "superscript")
